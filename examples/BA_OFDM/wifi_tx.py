...
# Title: Wifi Tx
# Generated: Fri Feb  1 13:33:57 2019
##################################################
...
class wifi_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ieee802_11_baofdm_mac_0 = ieee802_11_baofdm.mac(([0x23, 0x23, 0x23, 0x23, 0x23, 0x23]), ([0x42, 0x42, 0x42, 0x42, 0x42, 0x42]), ([0xff, 0xff, 0xff, 0xff, 0xff, 255]))
        ...
        # Connections
        ##################################################
        self.msg_connect((self.blocks_message_strobe_0_0, 'strobe'), (self.ieee802_11_baofdm_mac_0, 'app in'))
        self.msg_connect((self.blocks_socket_pdu_0, 'pdus'), (self.ieee802_11_baofdm_mac_0, 'app in'))
        self.msg_connect((self.ieee802_11_baofdm_mac_0, 'phy out'), (self.wifi_phy_hier_0, 'mac_in'))
        self.msg_connect((self.wifi_phy_hier_0, 'mac_out'), (self.ieee802_11_baofdm_mac_0, 'phy in'))
