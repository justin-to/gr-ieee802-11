...
# Title: Wifi Rx
# Generated: Fri Feb  1 14:17:28 2019
##################################################
...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._chan_est_options = [ieee802_11_baofdm.LS, ieee802_11_baofdm.LMS, ieee802_11_baofdm.STA, ieee802_11_baofdm.COMB]
        ...
        self.ieee802_11_baofdm_sync_short_0 = ieee802_11_baofdm.sync_short(0.56, 2, False, False)
        self.ieee802_11_baofdm_sync_long_0 = ieee802_11_baofdm.sync_long(sync_length, True, False)
        self.ieee802_11_baofdm_parse_mac_0 = ieee802_11_baofdm.parse_mac(True, True)
        self.ieee802_11_baofdm_moving_average_xx_1 = ieee802_11_baofdm.moving_average_ff(window_size + 16)
        self.ieee802_11_baofdm_moving_average_xx_0 = ieee802_11_baofdm.moving_average_cc(window_size)
        self.ieee802_11_baofdm_frame_equalizer_0 = ieee802_11_baofdm.frame_equalizer(chan_est, freq, samp_rate, False, False, 64, 48, 4, (range(-26, -21) + range(-20, -7) + range(-6, 0) + range(1, 7) + range(8, 21) + range(22, 27),))
        self.ieee802_11_baofdm_decode_mac_0 = ieee802_11_baofdm.decode_mac(True, False, 48)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ieee802_11_baofdm_decode_mac_0, 'out'), (self.foo_wireshark_connector_0, 'in'))
        self.msg_connect((self.ieee802_11_baofdm_decode_mac_0, 'out'), (self.ieee802_11_baofdm_parse_mac_0, 'in'))
        self.msg_connect((self.ieee802_11_baofdm_frame_equalizer_0, 'symbols'), (self.blocks_pdu_to_tagged_stream_1, 'pdus'))
        self.connect((self.blocks_complex_to_mag_0, 0), (self.blocks_divide_xx_0, 0))
        self.connect((self.blocks_complex_to_mag_squared_0, 0), (self.ieee802_11_baofdm_moving_average_xx_1, 0))
        self.connect((self.blocks_conjugate_cc_0, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.blocks_delay_0, 0), (self.ieee802_11_baofdm_sync_long_0, 0))
        self.connect((self.blocks_delay_0_0, 0), (self.blocks_conjugate_cc_0, 0))
        self.connect((self.blocks_delay_0_0, 0), (self.ieee802_11_baofdm_sync_short_0, 0))
        self.connect((self.blocks_divide_xx_0, 0), (self.ieee802_11_baofdm_sync_short_0, 2))
        self.connect((self.blocks_divide_xx_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.ieee802_11_baofdm_moving_average_xx_0, 0))
        self.connect((self.blocks_pdu_to_tagged_stream_1, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.blocks_stream_to_vector_0, 0), (self.fft_vxx_0, 0))
        self.connect((self.fft_vxx_0, 0), (self.ieee802_11_baofdm_frame_equalizer_0, 0))
        self.connect((self.foo_wireshark_connector_0, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.ieee802_11_baofdm_frame_equalizer_0, 0), (self.ieee802_11_baofdm_decode_mac_0, 0))
        self.connect((self.ieee802_11_baofdm_moving_average_xx_0, 0), (self.blocks_complex_to_mag_0, 0))
        self.connect((self.ieee802_11_baofdm_moving_average_xx_0, 0), (self.ieee802_11_baofdm_sync_short_0, 1))
        self.connect((self.ieee802_11_baofdm_moving_average_xx_1, 0), (self.blocks_divide_xx_0, 1))
        self.connect((self.ieee802_11_baofdm_sync_long_0, 0), (self.blocks_stream_to_vector_0, 0))
        self.connect((self.ieee802_11_baofdm_sync_short_0, 0), (self.blocks_delay_0, 0))
        self.connect((self.ieee802_11_baofdm_sync_short_0, 0), (self.ieee802_11_baofdm_sync_long_0, 1))
    ...
    def set_window_size(self, window_size):
        ...
        self.ieee802_11_baofdm_moving_average_xx_1.set_length(self.window_size + 16)
        self.ieee802_11_baofdm_moving_average_xx_0.set_length(self.window_size)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.ieee802_11_baofdm_frame_equalizer_0.set_bandwidth(self.samp_rate)
    ...
    def set_freq(self, freq):
        ...
        self._freq_callback(self.freq)
        self.uhd_usrp_source_0.set_center_freq(uhd.tune_request(self.freq, rf_freq = self.freq - self.lo_offset, rf_freq_policy=uhd.tune_request.POLICY_MANUAL), 0)
        self.ieee802_11_baofdm_frame_equalizer_0.set_frequency(self.freq)
    ...
    def set_chan_est(self, chan_est):
        ...
        self._chan_est_callback(self.chan_est)
        self.ieee802_11_baofdm_frame_equalizer_0.set_algorithm(self.chan_est)
